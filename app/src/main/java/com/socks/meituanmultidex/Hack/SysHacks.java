...
import com.socks.meituanmultidex.Hack.Hack.HackedClass;
import com.socks.meituanmultidex.Hack.Hack.HackedField;
import com.socks.meituanmultidex.framework.AssertionArrayException;
...
public class SysHacks extends Hack.HackDeclaration implements Hack.AssertionFailureHandler {
    ...
    public static Hack.HackedClass<android.content.ContextWrapper> ContextWrapper;
